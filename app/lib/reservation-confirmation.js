 ...
 * La page /merci la lit puis la supprime pour éviter l'accès direct.
 */
export const RESERVATION_CONFIRMATION_SESSION_KEY =
  "taxi_dracenie_reservation_confirmed_v1";

/** Cookie court (secours si sessionStorage bloqué) */
export const RESERVATION_CONFIRMATION_COOKIE = "taxi_dracenie_merci_ok";
